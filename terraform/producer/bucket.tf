...
resource "aws_s3_object" "raw_dummy" {
  ...
  key    = "dummy.csv"
  source = "${path.module}/dummy.csv"
  etag   = filemd5("${path.module}/dummy.csv")
}
...
# ----------------------------------------------------------------------------------------------
# S3 Bucket Object - Trusted Dummy
# ----------------------------------------------------------------------------------------------
resource "aws_s3_object" "trusted_dummy" {
...
# ----------------------------------------------------------------------------------------------
# S3 Bucket Object - Refined Dummy
# ----------------------------------------------------------------------------------------------
resource "aws_s3_object" "refined_dummy" {
